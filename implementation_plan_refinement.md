...
- **Files Modified:**
    - `assets/js/marquee-single.js`: Injects global marquee before the footer on non-services pages.
    - `assets/css/marquee-single.css`: Styles the global single-row marquee and shared lightbox.
