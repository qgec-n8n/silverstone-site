...
- **Files Modified:**
    - `assets/js/marquee-double.js` and `assets/css/marquee-double.css`: Double-deck logic and styling.
    - `assets/js/marquee-single.js` and `assets/css/marquee-single.css`: Single-row logic and styling.
