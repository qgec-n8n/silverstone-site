/* eslint-disable react-hooks/purity, react-hooks/immutability, react-hooks/preserve-manual-memoization, react-hooks/refs --
 * Vendored ElevenLabs UI registry component. React Three Fiber drives the
...
type OrbUniforms = {
  ...
  uPerlinTexture: THREE.Uniform<THREE.Texture>;
...
function Scene({
  ...
  useEffect(() => {
    const apply = () => {
      ...
      const activeUniforms = circleRef.current.material
        .uniforms as unknown as OrbUniforms;
      activeUniforms.uInverted.value = isDark ? 1 : 0;
    };
