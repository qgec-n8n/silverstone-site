  ...
  return (
    ...
    >
      ...
      <desc id="vsigLoomDesc">
        Vertical channel threads crossed by source rows, with one signal thread woven
        through.
      </desc>
      ...
      <path
        className="ss-vsig__signal"
        d="M28 128 C70 128 70 44 120 44 C170 44 170 128 212 128"
      />
