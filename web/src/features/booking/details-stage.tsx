...
export function DetailsStage({
  ...
  return (
    <div className="ss-booking-stage ss-booking-details">
      <div className="ss-booking-stage__heading ss-booking-stage__heading--details">
      ...
      <div className="ss-booking-details__body">
        {/* Two balanced columns — identity fields left, context and consent
            right — so the stage always fits the fixed shell without its own
            scrollbar. */}
        <form
        ...
        >
          <div className="ss-booking-details__fields">
            <label>
            ...
            <div className="ss-booking-details__pair">
              <label>
          ...
          <div className="ss-booking-details__aside">
