 ...
 * responsive reflow, and a conversion path (Discover → Experience → Convert →
 * Optimise) carries a travelling signal. No magnifying glass; unrelated to the
...
export function ConversionArchitecture() {
  ...
  return (
    <div
      ...
      role="img"
      aria-label="Diagram: a website interface assembles across desktop and mobile, feeding a conversion path from discover to experience to convert to optimise."
    >
      <m.svg
        viewBox="0 0 600 420"
      ...
      >
        ...
        <rect x="0" y="0" width="600" height="420" fill="url(#srv2-conv-glow)" />
