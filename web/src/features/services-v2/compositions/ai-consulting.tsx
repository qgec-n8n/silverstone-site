...
import { OpportunityObservatory } from "../signatures/opportunity-observatory";
import { aiConsultingCopy } from "../content/copy";
import type { RouteArt } from "../content/route-art";

const featureIcons = [Target, Gauge, ShieldCheck, Sparkles];
...
export function AiConsultingComposition({
  content,
  art,
}: {
