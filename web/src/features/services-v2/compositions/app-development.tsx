 ...
 * integration slots) — the signature itself is the demonstration: a disciplined
 * system that shows its state, rather than a static feature list.
 */
...
import { ProductStateEngine } from "../signatures/product-state-engine";
import { appDevelopmentCopy } from "../content/copy";
import type { RouteArt } from "../content/route-art";

const featureIcons = [Layers, Database, Plug, Smartphone];
...
export function AppDevelopmentComposition({
  content,
  art,
}: {
