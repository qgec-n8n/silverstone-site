...
import { VoiceCallDemo } from "../demos/voice-call-demo";
import { SignalWaveform } from "../signatures/signal-waveform";
import { aiVoiceAgentsCopy } from "../content/copy";
import type { RouteArt } from "../content/route-art";

const featureIcons = [PhoneCall, Activity, ShieldCheck, CalendarCheck];
...
export function AiVoiceAgentsComposition({
  content,
  art,
}: {
