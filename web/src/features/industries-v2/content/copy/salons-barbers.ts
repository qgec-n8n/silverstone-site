...
export const salonsBarbersCopy: IndustryCopy = {
  ...
  h1: "Protect *sellable chair time* without adding front-desk pressure",
  heroSub:
    "An empty chair earns nothing. Silverstone answers the calls you can't, refills cancellations **while the slot still has value**, and rebooks clients before the relationship cools.",
  heroPoints: [
  ...
  trustTokens: ["Diary-controlled", "Deposit-aware", "Consent-led", "Practitioner-owned"],
  problem: {
  ...
  process: {
    ...
    steps: [
      ...
      { title: "One journey first", body: "Missed-call capture or cancellation refill." },
      {
        title: "Integration test",
        body: "Availability, payments, client status — proven.",
      },
      { title: "Controlled launch", body: "Double-book risk monitored live." },
      { title: "Refine on behaviour", body: "Timing and segments tuned from real data." },
    ],
  },
  fit: {
