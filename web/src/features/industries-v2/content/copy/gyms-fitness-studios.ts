...
export const gymsFitnessStudiosCopy: IndustryCopy = {
  ...
  problem: {
    ...
    cards: [
      ...
      },
      {
        ...
        body: "Attendance recorded, the right staff action triggered.",
      },
      {
        title: "Class capacity shifts fast",
        body: "Timetable and waitlist tied to your live system.",
      },
      {
        title: "Inactive isn't identical",
        body: "Segmented by status and consent before a single message sends.",
      },
    ],
  },
  journey: {
    ...
    stages: [
      ...
      {
        title: "Trial routed",
        body: "A real trial or tour slot, with access and preparation info attached.",
      },
      {
      ...
      },
      {
        ...
        body: "Follow-up reflects what actually happened, not a guess.",
      },
      {
  ...
  workflows: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Released places offered in order, stopped the moment a spot is confirmed.",
      },
      {
  ...
  process: {
    ...
    steps: [
      ...
      { title: "Review and expand", body: "Scope grows only once it's proven." },
    ],
  },
  fit: {
    ...
    caution:
      "Not a fit if membership systems aren't authoritative, cancellation practices are deliberately opaque, or automation is expected to give health advice.",
  },
  faqs: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes, using attendance and consent-aware status. High-value conversations always stay with staff.",
      },
      {
