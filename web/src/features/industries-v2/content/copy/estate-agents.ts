...
export const estateAgentsCopy: IndustryCopy = {
  ...
  h1: "Turn property enquiries into *owned branch conversations*",
  heroSub:
    "Every unanswered portal lead is a fee your competitor is quoting on. Silverstone answers in **seconds**, qualifies the enquiry and hands your negotiators a conversation — not a queue.",
  heroPoints: [
