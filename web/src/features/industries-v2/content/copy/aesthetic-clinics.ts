...
export const aestheticClinicsCopy: IndustryCopy = {
  ...
  routeEntry: {
    ...
    subtitle:
      "Answer every enquiry in seconds, hold the deposit up front, and keep every clinical judgement — and every prescription-only medicine — with your prescriber.",
  ...
  sprint: {
    ...
    section: {
      ...
      lead: "A tightly scoped sprint on the enquiries your clinic already receives. Fixed scope, fixed price, fixed delivery window — six deliverables, nothing padded around them.",
    },
    deliverables: [
      {
        title: "Website conversion redesign",
        body: "The pages that decide a booking — treatment, consultation and enquiry pages — rebuilt around one clear path to a consultation instead of a brochure.",
      },
      {
        title: "Mobile booking journey",
        body: "Most aesthetic enquiries arrive on a phone. The booking route is rebuilt for a thumb: fewer steps, no pinch-zoom, no dead ends.",
      },
      {
        title: "Immediate enquiry response",
        body: "Every new website enquiry gets an answer in seconds rather than the next morning — written to UK advertising rules, naming no prescription-only medicine.",
      },
      {
        title: "Three-message follow-up",
        body: "A structured three-message sequence for enquiries that do not book first time. It stops the moment someone books or opts out.",
      },
      {
        title: "Booking and conversion tracking",
        body: "Enquiries, bookings and the conversion rate between them measured properly, so the next decision is made on your numbers rather than a hunch.",
      },
      {
    ...
    dayTrack: [
      ...
      { day: "Day 5", label: "Instant enquiry reply live" },
  ...
  caseStudy: {
    ...
    points: [
      "38-treatment catalogue, structured for search and for choosing",
  ...
  problem: {
    heading: "The enquiry is rarely the problem. *The gap after it is.*",
    body: "A DM lands at 21:40. A form arrives mid-treatment. A call rings out while you are in a sterile field. By the time the clinic replies the next morning, **the enquirer has already booked a consultation somewhere else** — and nothing about that was a marketing failure.",
    cards: [
      {
  ...
  workflows: {
    ...
    lead: "Aesthetic enquiries are comparison-shopped within the hour. These are the journeys that decide who gets the consultation.",
    items: [
      {
      ...
      },
      {
        ...
        body: "Most enquiries do not convert on the first exchange. A sequenced, value-adding follow-up runs to your cadence and stops the moment someone books or opts out.",
      },
      {
    ...
    stages: [
      {
        ...
        body: "Enquiries resolved by category and outcome — never by naming a prescription-only product.",
      },
      {
  ...
  services: {
    ...
    paragraphs: [
      "An [AI receptionist for clinic enquiries](/services/ai-receptionists) answers routine questions and books consultations, while [voice handling](/services/ai-voice-agents) captures the calls that ring out during treatment.",
  ...
  proof: {
    ...
    lead: "Verified Silverstone AI delivery results across response speed, enquiry conversion, attendance and admin.",
    metrics: [
  ...
  process: {
    ...
    steps: [
      {
        title: "Clinic review",
        body: "Treatments, consultation types, clinicians, rooms and current enquiry routes.",
      },
      {
  ...
  fit: {
    ...
    lead: "The strongest results come from clinics with real enquiry volume and a willingness to write their rules down.",
    right: [
  ...
  faqs: {
    ...
    items: [
      {
        q: "Can the system mention Botox or filler brands to enquirers?",
   ...
   */
  midCta: {
    heading: "Not ready for the sprint? *Bring one week of enquiries*",
