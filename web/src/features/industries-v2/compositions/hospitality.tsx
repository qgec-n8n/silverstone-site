 ...
 * boundary closes hard before delivery.
 */
...
import { GuestRadar } from "../signatures/guest-radar";
...
const painIcons = [PhoneCall, CalendarClock, Users, MessageSquare];
const workflowIcons = [Inbox, Users, BellRing, Star];

export function HospitalityComposition({
  copy,
  art,
}: {
  copy: IndustryCopy;
  ...
  return (
    <div className="ss-srv2 ss-ind2" data-industry="hospitality" style={accentStyle}>
      <SecondaryHero
      ...
      <section className="ss-srv2-section" aria-label="Illustrative guest experience">
        <div className="ss-srv2__container">
          <Reveal kind="image">
      ...
      <section className="ss-srv2-section" aria-labelledby="ind2-boundary">
        <div className="ss-srv2__container">
          ...
          <BoundaryPanel
            ...
            keepsLabel="With the team on duty, always"
          />
        </div>
      </section>
      ...
      <section className="ss-srv2-section" aria-label="Illustrative reservation flows">
        <div className="ss-srv2__container">
