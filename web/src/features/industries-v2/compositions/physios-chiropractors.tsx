 ...
 * the systems story; proof arrives late as access evidence.
 */
...
import { CareTimeline } from "../signatures/care-timeline";
...
const painIcons = [Inbox, CalendarClock, FileText, BellRing];
const workflowIcons = [CalendarClock, BellRing, ClipboardCheck, UserCheck];

export function PhysiosChiropractorsComposition({
  copy,
  art,
}: {
  copy: IndustryCopy;
  ...
  return (
    <div
      ...
      data-industry="physios-chiropractors"
      style={accentStyle}
    >
      <SecondaryHero
        ...
        showcase={<CareTimeline label={art.discipline} metrics={metrics.slice(0, 2)} />}
      />
      <TrustStrip />
      ...
      <section className="ss-srv2-section" aria-labelledby="ind2-problem">
        <div className="ss-srv2__container">
          <SectionHead
            eyebrow="Outside the treatment room"
            icon={art.icon}
      ...
      <section className="ss-srv2-section" aria-labelledby="ind2-boundary">
        <div className="ss-srv2__container">
          ...
          <BoundaryPanel
            ...
            keepsLabel="With clinicians, always"
          />
        </div>
      </section>
      ...
      <section className="ss-srv2-section" aria-labelledby="ind2-workflows">
        <div className="ss-srv2__container">
          <SectionHead
            eyebrow="Continuity of care admin"
            icon={BellRing}
