 ...
 */
export const CALENDLY_URL = `${CALENDLY_ORIGIN}/silverstone-ai/30min?embed_domain=silverstone-ai.com&embed_type=Inline&hide_landing_page_details=1&hide_event_type_details=1&hide_gdpr_banner=1&primary_color=0891b2&text_color=0b1220&background_color=ffffff`;
