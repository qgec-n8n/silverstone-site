...
const approvedContent = [
  ...
  ...[
    {
      id: "content-service-web-design-development",
      routeId: "route-service-web-design-development",
      routePath: "/services/web-design-development",
      ...
      sourceRouteKey: "approved:/services/web-design-development",
      sections: [
        {
          heading: "The problem this service addresses",
          paragraphs: [
            "A website can look polished and still leave visitors unsure what the business does, who it is for or what to do next. The work starts by reducing that uncertainty, not by choosing animation or a component library.",
          ],
        },
        {
          ...
          list: {
            items: [
              ...
              "Information architecture and conversion copy",
              "Responsive interface design",
              "Front-end development and integrations",
        ...
        },
        {
          ...
          list: {
            items: [
              "Rebuilding an outdated brochure site",
              "Creating a conversion path for a new service",
              "Separating service and industry content",
              "Improving forms, booking and lead handoff",
              "Migrating content without losing useful URLs",
            ],
          },
        },
        {
          ...
          paragraphs: [
            "A useful fit starts with a repeated problem, a content owner and a defined route to enquiry or booking.",
            "Guaranteed rankings, invented proof and open-ended redesigns without a first release are outside the default scope.",
          ],
        },
        {
          heading: "Proof and related pages",
          paragraphs: [
            linkParagraph(
              "Until approved portfolio evidence exists, any demonstration remains clearly labelled as illustrative. Related sector pages include Estate Agents, Hospitality, Salons & Barbers, Trades & Home Services, eCommerce Brands and Physio & Chiropractic Clinics.",
              [
                { href: "/services/estate-agents", text: "Estate Agents" },
                { href: "/services/hospitality", text: "Hospitality" },
                { href: "/services/salons-barbers", text: "Salons & Barbers" },
    ...
    {
      id: "content-service-app-development",
      routeId: "route-service-app-development",
      routePath: "/services/app-development",
      ...
      sourceRouteKey: "approved:/services/app-development",
      sections: [
        {
          heading: "The problem this service addresses",
          paragraphs: [
            "App projects become expensive when the first scope is a collection of ideas rather than a validated user journey. A focused product definition reduces rework and makes technical decisions easier to explain.",
          ],
        },
        {
          heading: "What the service can include",
          list: {
            items: [
              ...
              "User journeys and prototype",
              "Web or mobile application development",
              "Authentication and role design where required",
              "API and system integrations",
              "Testing, documentation and staged release",
            ],
          },
        },
        {
          ...
          list: {
            items: [
              "A customer portal for repeat actions",
              "A staff tool replacing fragile spreadsheets",
              "A booking, intake or document workflow",
              "A mobile companion for an existing service",
              "A prototype used to test demand before a larger build",
            ],
          },
        },
        {
          heading: "Fit and boundaries",
          paragraphs: [
            "A useful fit starts with one priority user, one priority task and acceptance criteria for the first release.",
            "Unsupported security or compliance claims, and large builds without a validated first release, are not part of the default promise.",
          ],
        },
        {
          ...
          paragraphs: [
            linkParagraph(
              "Relevant sectors include Estate Agents, Hospitality, eCommerce Brands, Physio & Chiropractic Clinics, Dental Practices and Gyms & Fitness Studios.",
              [
                { href: "/services/estate-agents", text: "Estate Agents" },
                { href: "/services/hospitality", text: "Hospitality" },
                { href: "/services/ecommerce", text: "eCommerce Brands" },
    ...
    {
      id: "content-service-ai-voice-agents",
      routeId: "route-service-ai-voice-agents",
      routePath: "/services/ai-voice-agents",
      ...
      sourceRouteKey: "approved:/services/ai-voice-agents",
      sections: [
        {
          heading: "The problem this service addresses",
          paragraphs: [
            "Phone calls contain context that menus and voicemail often lose. A voice agent can support a defined conversational flow, but only when knowledge, action permissions and human handoff are designed explicitly.",
          ],
        },
        {
          heading: "What the service can include",
          list: {
            items: [
              ...
              "Inbound or outbound voice workflows",
              "Qualification, routing and message capture",
              "Booking or CRM actions where appropriate",
              "Testing, monitoring and human handoff rules",
            ],
          },
        },
        {
          ...
          list: {
            items: [
              "Capturing missed or out-of-hours enquiries",
              "Qualifying routine inbound calls",
              "Confirming or requesting appointments",
              "Collecting job or property details",
              "Routing callers by approved business rules",
            ],
          },
        },
        {
          heading: "Fit and boundaries",
          paragraphs: [
            "Sensitive, unusual or regulated decisions stay with an authorised person. Disclosure, retry limits, fallback wording and escalation are part of the product.",
          ],
        },
        {
          heading: "Related pages",
          paragraphs: [
            linkParagraph(
              "Relevant sectors include Estate Agents, Hospitality, Trades & Home Services, Physio & Chiropractic Clinics, Dental Practices and Gyms & Fitness Studios.",
              [
                { href: "/services/estate-agents", text: "Estate Agents" },
                { href: "/services/hospitality", text: "Hospitality" },
                { href: "/services/trades", text: "Trades & Home Services" },
    ...
    {
      id: "content-service-ai-receptionists",
      routeId: "route-service-ai-receptionists",
      routePath: "/services/ai-receptionists",
      ...
      sourceRouteKey: "approved:/services/ai-receptionists",
      sections: [
        {
          heading: "The problem this service addresses",
          paragraphs: [
            "Front-desk work is spread across phone, web chat, email, forms and booking tools. The useful product is not a generic chatbot; it is a controlled intake and routing layer based on the organisation’s actual rules.",
          ],
        },
        {
          heading: "What the service can include",
          list: {
            items: [
              "Phone, web or messaging intake",
              "FAQ and availability responses",
              "Message-taking and contact capture",
              "Appointment request or booking flows",
              "Escalation and exception handling",
              "Reporting and iterative improvement",
            ],
          },
        },
        {
          ...
          list: {
            items: [
              "Answering approved practical questions",
              "Taking structured messages",
              "Directing visitors to the right booking route",
              "Collecting minimum enquiry details",
              "Sending routine confirmations and follow-up",
            ],
          },
        },
        {
          heading: "Fit and boundaries",
          paragraphs: [
            "Clinical, legal or financial judgement stays with people. The product supports repeatable first-response work, not every conversation the business will ever have.",
          ],
        },
        {
          heading: "Related pages",
          paragraphs: [
            linkParagraph(
              "Relevant sectors include Estate Agents, Hospitality, Salons & Barbers, Trades & Home Services, eCommerce Brands and Physio & Chiropractic Clinics.",
              [
                { href: "/services/estate-agents", text: "Estate Agents" },
                { href: "/services/hospitality", text: "Hospitality" },
                { href: "/services/salons-barbers", text: "Salons & Barbers" },
    ...
    {
      id: "content-service-content-creation",
      routeId: "route-service-content-creation",
      routePath: "/services/content-creation",
      ...
      sourceRouteKey: "approved:/services/content-creation",
      sections: [
        {
          heading: "The problem this service addresses",
          paragraphs: [
            "Content becomes risky or generic when it is generated without approved source material, a named audience or an editorial owner. A useful system begins with expertise and provenance, then repurposes it deliberately.",
          ],
        },
        {
          heading: "What the service can include",
          list: {
            items: [
              ...
              "Interview or source-led drafting",
              "Website and landing-page copy",
              "Article, email and social repurposing",
              "Editorial review and claim checks",
              "Publishing workflow and performance review",
            ],
          },
        },
        {
          ...
          list: {
            items: [
              "Turning interviews into service-page copy",
              "Building a search-aware article cluster",
              "Repurposing one approved article into email and social posts",
              "Creating sales enablement from existing expertise",
              "Maintaining a review queue for regulated or sensitive content",
            ],
          },
        },
        {
          heading: "Fit and boundaries",
          paragraphs: [
            "Fabricated expertise, clients or results are out of scope. So is volume publishing without review for risk, brand and accuracy.",
          ],
        },
        {
          heading: "Related pages",
    ...
    {
      id: "content-service-ai-automation",
      routeId: "route-service-ai-automation",
      ...
      sourceRouteKey: "approved:/services/ai-automation",
      sections: [
        {
          heading: "The problem this service addresses",
          paragraphs: [
            "Many teams already have capable software but still copy information, chase approvals and remember follow-up manually. Automation should remove a defined handoff or decision delay without hiding accountability.",
          ],
        },
        {
          heading: "What the service can include",
          list: {
            items: [
              "Workflow audit and opportunity prioritisation",
              "System and data mapping",
              "Agent and automation design",
              "Email, CRM, document and scheduling workflows",
        ...
        },
        {
          ...
          list: {
            items: [
              ...
              "CRM, email and calendar coordination",
              "Status notifications and task creation",
              "Reporting workflows with human approval points",
            ],
          },
        },
        {
          heading: "Fit and boundaries",
          paragraphs: [
            "Unbounded autonomous decision-making and unsupported savings or return claims are excluded. The first scope should keep an accountable owner in the loop.",
          ],
        },
        {
          heading: "Related pages",
