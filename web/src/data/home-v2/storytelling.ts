...
export const STORY_PANELS: readonly StoryPanel[] = [
  ...
  },
  {
    ...
    body: "Automation handles the volume; your team keeps the judgment. Every workflow has clear review points, approval gates and an audit trail, so a person stays accountable for the decisions that matter. You choose what runs autonomously and what waits for a human nod, and you can move those boundaries as trust grows. It is leverage without losing oversight — speed where it is safe, and a human firmly in the signal everywhere it counts.",
