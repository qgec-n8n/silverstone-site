...
export const HEADLINE_BENCHMARKS: readonly BenchmarkMetric[] = [
  ...
  },
  {
    ...
    context:
      "Speed an AI front desk answers inquiries, day or night, before a lead cools.",
...
export const SECONDARY_BENCHMARKS: readonly BenchmarkMetric[] = [
  {
    ...
    context: "Inquiry growth seen when capture and follow-up are handled quickly.",
  ...
  },
  {
    ...
    context: "Upper end of return reported across mature automation programs.",
    impactArea: "ROI",
    source: "AI Agents & Automation Workflows",
    tier: "secondary",
  },
