import {
  require_react_dom
} from "./chunk-CLT6YDAL.js";
import {
  require_jsx_runtime
} from "./chunk-E6ICPE72.js";
import {
  require_react
} from "./chunk-IDLMBQNO.js";
import {
  __export,
  __toESM
...
var AccessibleIcon = ({ children, label }) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    ...
    (0, import_jsx_runtime3.jsx)(Root2, { children: label })
  ] });
};
...
var AccordionImplSingle = React15.forwardRef(
  (props, forwardedRef) => {
    const {
      value: valueProp,
      defaultValue,
    ...
    return (0, import_jsx_runtime9.jsx)(
      AccordionValueProvider,
      {
        ...
        value: React15.useMemo(() => value ? [value] : [], [value]),
        onItemOpen: setValue,
        onItemClose: React15.useCallback(() => collapsible && setValue(""), [collapsible, setValue]),
...
var AccordionImplMultiple = React15.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  const handleItemOpen = React15.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleItemClose = React15.useCallback(
...
var AccordionImpl = React15.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAccordion, disabled, dir, orientation = "vertical", ...accordionProps } = props;
    const accordionRef = React15.useRef(null);
...
var DismissableLayer = React18.forwardRef(
  (props, forwardedRef) => {
    ...
    const isDeferredPointerDownOutsideRef = React18.useRef(false);
...
function usePointerDownOutside(onPointerDownOutside, args) {
  ...
  const isPointerDownOutsideRef = React18.useRef(false);
  const interceptedOutsideInteractionEventsRef = React18.useRef(/* @__PURE__ */ new Map());
...
var Portal = React20.forwardRef((props, forwardedRef) => {
  ...
  return container ? ReactDOM2.createPortal((0, import_jsx_runtime12.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime13.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React34.Children.map(children, (child) => (0, import_jsx_runtime13.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime13.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlayImpl = React34.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      (0, import_jsx_runtime13.jsx)(Combination_default, { as: Slot2, allowPinchZoom: true, shards: [context.contentRef], children: (0, import_jsx_runtime13.jsx)(
        Primitive.div,
        {
          "data-state": getState3(context.open),
          ...overlayProps,
...
var DialogContentImpl = React34.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    return (0, import_jsx_runtime13.jsx)(import_jsx_runtime13.Fragment, { children: (0, import_jsx_runtime13.jsx)(
      FocusScope,
      {
        asChild: true,
        loop: true,
...
var AlertDialog = (props) => {
  ...
  return (0, import_jsx_runtime14.jsx)(Dialog, { ...dialogScope, ...alertDialogProps, modal: true });
};
...
var AlertDialogTrigger = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime14.jsx)(DialogTrigger, { ...dialogScope, ...triggerProps, ref: forwardedRef });
  }
);
...
var AlertDialogPortal = (props) => {
  ...
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime14.jsx)(DialogPortal, { ...dialogScope, ...portalProps });
};
...
var AlertDialogOverlay = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime14.jsx)(DialogOverlay, { ...dialogScope, ...overlayProps, ref: forwardedRef });
  }
);
...
var AlertDialogContent = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime14.jsx)(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: (0, import_jsx_runtime14.jsx)(
      DialogContent,
      {
        role: "alertdialog",
        ...dialogScope,
...
var AlertDialogTitle = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime14.jsx)(DialogTitle, { ...dialogScope, ...titleProps, ref: forwardedRef });
  }
);
...
var AlertDialogDescription = React35.forwardRef((props, forwardedRef) => {
  ...
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime14.jsx)(DialogDescription, { ...dialogScope, ...descriptionProps, ref: forwardedRef });
});
...
var AlertDialogAction = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime14.jsx)(DialogClose, { ...dialogScope, ...actionProps, ref: forwardedRef });
  }
);
...
var AlertDialogCancel = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime14.jsx)(DialogClose, { ...dialogScope, ...cancelProps, ref });
  }
);
...
var AvatarImage = React37.forwardRef(
  (props, forwardedRef) => {
    ...
    const loadingStatusRef = React37.useRef(imageLoadingStatus);
    useLayoutEffect2(() => {
...
function useImageCount() {
  ...
  if (true) {
    state = React37.useState(0);
    const [imageCount] = state;
    const hasWarnedRef = React37.useRef(false);
    React37.useEffect(() => {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime17.jsx)(
      CheckboxProvider,
      {
        ...
        form,
        value,
        internal_do_not_use_render: ({ isFormControl: isFormControl2 }) => (0, import_jsx_runtime17.jsxs)(import_jsx_runtime17.Fragment, { children: [
...
var Popper = (props) => {
  ...
  const [placementState, setPlacementState] = React43.useState(void 0);
...
var PopperAnchor = React43.forwardRef(
  (props, forwardedRef) => {
    ...
    const callbackRef = React43.useCallback(
      (node) => {
        ref.current = node;
        if (node) {
          onAnchorChange(node);
    ...
    return virtualRef ? null : (0, import_jsx_runtime19.jsx)(
      Primitive.div,
      {
...
var ContextMenu = (props) => {
  ...
  const hasInteractedRef = React46.useRef(false);
  if (true) {
    const hasWarnedRef = React46.useRef(false);
    React46.useEffect(() => {
  ...
  return (0, import_jsx_runtime22.jsx)(
    ContextMenuProvider,
    {
      ...
      modal,
      hasInteractedRef,
      children: (0, import_jsx_runtime22.jsx)(Root32, { ...menuScope, dir, open, onOpenChange: setOpen, modal, children })
    }
  );
};
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React53.useState(_isHydrated);
  React53.useEffect(() => {
    if (!_isHydrated) {
      _isHydrated = true;
      setIsHydrated(true);
...
var OneTimePasswordField = React54.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React54.useCallback(
      (value2) => {
    ...
    const controlledValue = React54.useMemo(() => {
    ...
    const [value, setValue] = useControllableState({
      ...
      onChange: React54.useCallback(
        (value2) => onValueChange?.(value2.join("")),
        [onValueChange]
      )
    });
    const latestValueRef = React54.useRef(value);
    latestValueRef.current = value;
    const dispatch = React54.useCallback(
      (action) => {
        ...
        switch (action.type) {
          ...
          case "PASTE": {
            ...
            focusInput(collection.at(value3.length - 1)?.element);
            return;
          }
        }
      },
    ...
    const validationTypeRef = React54.useRef(validation);
    React54.useEffect(() => {
      if (!validation) {
        return;
      }
    ...
    const hiddenInputRef = React54.useRef(null);
    const userActionRef = React54.useRef(null);
    ...
    const locateForm = React54.useCallback(() => {
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React54.useCallback(() => {
    ...
    const valueRef = React54.useRef(currentValue);
    ...
    return (0, import_jsx_runtime29.jsx)(
      OneTimePasswordFieldContext,
      {
        ...
        isHydrated,
        sanitizeValue,
        children: (0, import_jsx_runtime29.jsx)(Collection6.Provider, { scope: __scopeOneTimePasswordField, state: collectionState, children: (0, import_jsx_runtime29.jsx)(Collection6.Slot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime29.jsx)(
          Root8,
          {
            asChild: true,
            ...rovingFocusGroupScope,
...
var OneTimePasswordFieldHiddenInput = React54.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React54.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React54.useState(null);
  ...
  const keyboardActionTimeoutRef = React54.useRef(null);
  React54.useEffect(() => {
    return () => {
  ...
  return (0, import_jsx_runtime29.jsx)(Collection6.ItemSlot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime29.jsx)(
    Item2,
    {
      ...rovingFocusGroupScope,
      asChild: true,
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React55.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React55.useCallback(
  ...
  const focusState = React55.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React55.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React55.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React55.useState(void 0);
    const elementRef = React55.useRef(null);
...
var PasswordToggleFieldIcon = React55.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
    ...
    return (0, import_jsx_runtime30.jsx)(Primitive.svg, { ...domProps, ref: forwardedRef, "aria-hidden": true, asChild: true, children: visible ? visibleIcon : hiddenIcon });
  }
);
PasswordToggleFieldIcon.displayName = PASSWORD_TOGGLE_FIELD_ICON_NAME;
function requestIdleCallback(window2, callback, options2) {
  if (window2.requestIdleCallback) {
    const id2 = window2.requestIdleCallback(callback, options2);
    return () => {
...
var Popover = (props) => {
  ...
  return (0, import_jsx_runtime31.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime31.jsx)(
    PopoverProvider,
    {
...
var PopoverAnchor = React56.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime31.jsx)(Anchor, { ...popperScope, ...anchorProps, ref: forwardedRef });
  }
);
...
var PopoverTrigger = React56.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope3(__scopePopover);
    const composedTriggerRef = useComposedRefs(forwardedRef, context.triggerRef);
    const trigger = (0, import_jsx_runtime31.jsx)(
      Primitive.button,
      {
        type: "button",
        "aria-haspopup": "dialog",
    ...
    return context.hasCustomAnchor ? trigger : (0, import_jsx_runtime31.jsx)(Anchor, { asChild: true, ...popperScope, children: trigger });
  }
);
...
var PopoverPortal = (props) => {
  ...
  return (0, import_jsx_runtime31.jsx)(PortalProvider4, { scope: __scopePopover, forceMount, children: (0, import_jsx_runtime31.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime31.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var PopoverContent = React56.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime31.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? (0, import_jsx_runtime31.jsx)(PopoverContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime31.jsx)(PopoverContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
...
var PopoverContentModal = React56.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime31.jsx)(Combination_default, { as: Slot4, allowPinchZoom: true, children: (0, import_jsx_runtime31.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverArrow = React56.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope3(__scopePopover);
    return (0, import_jsx_runtime31.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var Progress = React57.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeProgress,
    ...
    return (0, import_jsx_runtime32.jsx)(ProgressProvider, { scope: __scopeProgress, value, max: max2, children: (0, import_jsx_runtime32.jsx)(
      Primitive.div,
      {
        "aria-valuemax": max2,
        "aria-valuemin": 0,
...
var ProgressIndicator = React57.forwardRef(
  (props, forwardedRef) => {
...
function RadioProvider(props) {
  ...
  const [control, setControl] = React58.useState(null);
  const [bubbleInput, setBubbleInput] = React58.useState(null);
  ...
  return (0, import_jsx_runtime33.jsx)(RadioProviderImpl, { scope: __scopeRadio, ...context, children: isFunction3(internal_do_not_use_render) ? internal_do_not_use_render(context) : children });
}
var TRIGGER_NAME12 = "RadioTrigger";
var RadioTrigger = React58.forwardRef(
  ({ __scopeRadio, onClick, ...radioProps }, forwardedRef) => {
    const {
      ...
      isFormControl: isFormControl2,
      bubbleInput
    } = useRadioContext(TRIGGER_NAME12, __scopeRadio);
    const composedRefs = useComposedRefs(forwardedRef, setControl);
...
RadioTrigger.displayName = TRIGGER_NAME12;
var Radio = React58.forwardRef(
  (props, forwardedRef) => {
...
var RadioIndicator = React58.forwardRef(
  (props, forwardedRef) => {
    const { __scopeRadio, forceMount, ...indicatorProps } = props;
    const context = useRadioContext(INDICATOR_NAME7, __scopeRadio);
    return (0, import_jsx_runtime33.jsx)(Presence, { present: forceMount || context.checked, children: (0, import_jsx_runtime33.jsx)(
      Primitive.span,
      {
...
var RadioBubbleInput = React58.forwardRef(
  ({ __scopeRadio, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React58.useRef(checked);
    return (0, import_jsx_runtime33.jsx)(
      Primitive.input,
      {
        type: "radio",
...
var RadioGroupItemTrigger = React211.forwardRef((props, forwardedRef) => {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime34.jsx)(
      RadioGroupItemProvider,
      {
        ...
        value,
        disabled,
        internal_do_not_use_render: ({ isFormControl: isFormControl2 }) => (0, import_jsx_runtime34.jsxs)(import_jsx_runtime34.Fragment, { children: [
...
var RadioGroupItemBubbleInput = React211.forwardRef((props, forwardedRef) => {
  const { __scopeRadioGroup, ...bubbleProps } = props;
  const radioScope = useRadioScope(__scopeRadioGroup);
  return (0, import_jsx_runtime34.jsx)(RadioBubbleInput, { ...radioScope, ...bubbleProps, ref: forwardedRef });
});
...
var RadioGroupIndicator = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    const radioScope = useRadioScope(__scopeRadioGroup);
    return (0, import_jsx_runtime34.jsx)(RadioIndicator, { ...radioScope, ...indicatorProps, ref: forwardedRef });
  }
);
...
var ScrollAreaViewport = React212.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime35.jsxs)(import_jsx_runtime35.Fragment, { children: [
      (0, import_jsx_runtime35.jsx)(ScrollAreaViewportStyle, { nonce }),
      (0, import_jsx_runtime35.jsx)(
        Primitive.div,
        {
          ...
          children: (0, import_jsx_runtime35.jsx)("div", { ref: context.onContentChange, style: { minWidth: "100%", display: "table" }, children })
        }
      )
    ] });
  }
...
var ScrollAreaViewportStyle = React212.memo(
  ({ nonce }) => {
    return (0, import_jsx_runtime35.jsx)(
      "style",
      {
...
var ScrollAreaScrollbar = React212.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.type === "hover" ? (0, import_jsx_runtime35.jsx)(ScrollAreaScrollbarHover, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "scroll" ? (0, import_jsx_runtime35.jsx)(ScrollAreaScrollbarScroll, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "auto" ? (0, import_jsx_runtime35.jsx)(ScrollAreaScrollbarAuto, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "always" ? (0, import_jsx_runtime35.jsx)(ScrollAreaScrollbarVisible, { ...scrollbarProps, ref: forwardedRef, "data-state": "visible" }) : null;
  }
);
...
var ScrollAreaScrollbarHover = React212.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime35.jsx)(Presence, { present: forceMount || visible, children: (0, import_jsx_runtime35.jsx)(
...
var ScrollAreaScrollbarScroll = React212.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime35.jsx)(Presence, { present: forceMount || state !== "hidden", children: (0, import_jsx_runtime35.jsx)(
...
var ScrollAreaThumb = React212.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime35.jsx)(Presence, { present: forceMount || scrollbarContext.hasThumb, children: (0, import_jsx_runtime35.jsx)(ScrollAreaThumbImpl, { ref: forwardedRef, ...thumbProps }) });
  }
);
...
var ScrollAreaCorner = React212.forwardRef(
  (props, forwardedRef) => {
    ...
    return hasCorner ? (0, import_jsx_runtime35.jsx)(ScrollAreaCornerImpl, { ...props, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaCornerImpl = React212.forwardRef((props, forwardedRef) => {
  ...
  return hasSize ? (0, import_jsx_runtime35.jsx)(
    Primitive.div,
    {
      ...cornerProps,
      ref: forwardedRef,
...
function SelectProvider(props) {
  ...
  const [valueNode, setValueNode] = React60.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React60.useState(false);
  const direction = useDirection(dir);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
  ...
  const triggerPointerDownPosRef = React60.useRef(null);
  const isFormControl2 = trigger ? !!form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React60.useState(/* @__PURE__ */ new Set());
  const contentId = useId();
  const nativeSelectKey = Array.from(nativeOptionsSet).map((option) => option.props.value).join(";");
  const handleNativeOptionAdd = React60.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React60.useCallback((option) => {
  ...
  return (0, import_jsx_runtime36.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime36.jsx)(SelectProviderImpl, { scope: __scopeSelect, ...context, children: (0, import_jsx_runtime36.jsx)(Collection7.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime36.jsx)(
    SelectNativeOptionsProvider,
    {
      scope: __scopeSelect,
      onNativeOptionAdd: handleNativeOptionAdd,
      onNativeOptionRemove: handleNativeOptionRemove,
      children: isFunction4(internal_do_not_use_render) ? internal_do_not_use_render(context) : children
    }
  ) }) }) });
}
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime36.jsx)(
    SelectProvider,
    {
      __scopeSelect,
      ...providerProps,
      internal_do_not_use_render: ({ isFormControl: isFormControl2 }) => (0, import_jsx_runtime36.jsxs)(import_jsx_runtime36.Fragment, { children: [
        children,
...
var TRIGGER_NAME13 = "SelectTrigger";
var SelectTrigger = React60.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, disabled = false, ...triggerProps } = props;
    const popperScope = usePopperScope4(__scopeSelect);
    const context = useSelectContext(TRIGGER_NAME13, __scopeSelect);
    const isDisabled = context.disabled || disabled;
    const composedRefs = useComposedRefs(forwardedRef, context.onTriggerChange);
    const getItems = useCollection7(__scopeSelect);
    const pointerTypeRef = React60.useRef("touch");
...
SelectTrigger.displayName = TRIGGER_NAME13;
var VALUE_NAME = "SelectValue";
var SelectValue = React60.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime36.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime36.jsx)(React60.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }
);
...
var SelectIcon = React60.forwardRef(
  (props, forwardedRef) => {
...
var [PortalProvider5, usePortalContext5] = createSelectContext(PORTAL_NAME10, {
  forceMount: void 0
});
var SelectPortal = (props) => {
  const { __scopeSelect, forceMount, ...portalProps } = props;
  return (0, import_jsx_runtime36.jsx)(PortalProvider5, { scope: props.__scopeSelect, forceMount, children: (0, import_jsx_runtime36.jsx)(Portal, { asChild: true, ...portalProps }) });
};
SelectPortal.displayName = PORTAL_NAME10;
var CONTENT_NAME13 = "SelectContent";
var SelectContent = React60.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext5(CONTENT_NAME13, props.__scopeSelect);
    const { forceMount = portalContext.forceMount, ...contentProps } = props;
    const context = useSelectContext(CONTENT_NAME13, props.__scopeSelect);
    const [fragment, setFragment] = React60.useState();
    useLayoutEffect2(() => {
      setFragment(new DocumentFragment());
    }, []);
    return (0, import_jsx_runtime36.jsx)(Presence, { present: forceMount || context.open, children: ({ present }) => present ? (0, import_jsx_runtime36.jsx)(SelectContentImpl, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime36.jsx)(SelectContentFragment, { ...contentProps, fragment }) });
  }
);
SelectContent.displayName = CONTENT_NAME13;
var SelectContentFragment = React60.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, children, fragment } = props;
  if (!fragment) return null;
  return ReactDOM5.createPortal(
    (0, import_jsx_runtime36.jsx)(SelectContentProvider, { scope: __scopeSelect, children: (0, import_jsx_runtime36.jsx)(Collection7.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime36.jsx)("div", { ref: forwardedRef, children }) }) }),
    fragment
  );
});
...
var SelectContentImpl = React60.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React60.useState(null);
    const [selectedItemText, setSelectedItemText] = React60.useState(
      null
    );
    const getItems = useCollection7(__scopeSelect);
    const [isPositioned, setIsPositioned] = React60.useState(false);
    const firstValidItemFoundRef = React60.useRef(false);
    React60.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst6 = React60.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React60.useCallback(
    ...
    const itemRefCallback = React60.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React60.useCallback(() => content?.focus(), [content]);
    const itemTextRefCallback = React60.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
    ...
    return (0, import_jsx_runtime36.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime36.jsx)(Combination_default, { as: Slot5, allowPinchZoom: true, children: (0, import_jsx_runtime36.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectItemAlignedPosition = React60.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME13, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME13, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React60.useState(null);
  const [content, setContent] = React60.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection7(__scopeSelect);
  const shouldExpandOnScrollRef = React60.useRef(false);
  const shouldRepositionRef = React60.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React60.useCallback(() => {
  ...
  const handleScrollButtonChange = React60.useCallback(
    (node) => {
...
var SelectPopperPosition = React60.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React60.forwardRef(
  (props, forwardedRef) => {
    ...
    const prevScrollTopRef = React60.useRef(0);
    return (0, import_jsx_runtime36.jsxs)(import_jsx_runtime36.Fragment, { children: [
      ...
      (0, import_jsx_runtime36.jsx)(Collection7.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime36.jsx)(
        Primitive.div,
        {
...
var SelectGroup = React60.forwardRef(
  (props, forwardedRef) => {
...
var SelectLabel = React60.forwardRef(
  (props, forwardedRef) => {
...
var SelectItem = React60.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
      value,
    ...
    const [textValue, setTextValue] = React60.useState(textValueProp ?? "");
    ...
    return (0, import_jsx_runtime36.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React60.useCallback((node) => {
...
var SelectItemText = React60.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React60.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React60.useMemo(
...
var SelectItemIndicator = React60.forwardRef(
  (props, forwardedRef) => {
...
var SelectScrollUpButton = React60.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React60.useState(false);
...
var SelectScrollDownButton = React60.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React60.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
...
var SelectScrollButtonImpl = React60.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React60.useRef(null);
  const getItems = useCollection7(__scopeSelect);
  const clearAutoScrollTimer = React60.useCallback(() => {
...
var SelectSeparator = React60.forwardRef(
  (props, forwardedRef) => {
...
var SelectArrow = React60.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...arrowProps } = props;
    const popperScope = usePopperScope4(__scopeSelect);
    const contentContext = useSelectContentContext(ARROW_NAME8, __scopeSelect);
    return contentContext.position === "popper" ? (0, import_jsx_runtime36.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
SelectArrow.displayName = ARROW_NAME8;
var BUBBLE_INPUT_NAME3 = "SelectBubbleInput";
var SelectBubbleInput = React60.forwardRef(
  ({ __scopeSelect, ...props }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime36.jsxs)(
      Primitive.select,
      {
        ...
        children: [
          shouldShowPlaceholder(value) && !hasEmptyValueOption ? (0, import_jsx_runtime36.jsx)("option", { value: "" }) : null,
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const searchRef = React60.useRef("");
  const timerRef = React60.useRef(0);
  const handleTypeaheadSearch = React60.useCallback(
    (key) => {
      const search = searchRef.current + key;
  ...
  const resetTypeahead = React60.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React60.useEffect(() => {
...
var Separator3 = React61.forwardRef((props, forwardedRef) => {
...
var Slider = React62.forwardRef(
  (props, forwardedRef) => {
    ...
    const isKeyboardInteractionRef = React62.useRef(false);
    ...
    return (0, import_jsx_runtime38.jsx)(
      SliderProvider,
      {
        ...
        orientation,
        form,
        children: (0, import_jsx_runtime38.jsx)(Collection8.Provider, { scope: props.__scopeSlider, children: (0, import_jsx_runtime38.jsx)(Collection8.Slot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime38.jsx)(
          SliderOrientation,
          {
...
function SliderThumbProvider(props) {
  ...
  return (0, import_jsx_runtime38.jsx)(SliderThumbContextProvider, { scope: __scopeSlider, ...thumbContext, children: isFunction5(internal_do_not_use_render) ? internal_do_not_use_render(thumbContext) : children });
}
SliderThumbProvider.displayName = THUMB_PROVIDER_NAME;
var THUMB_TRIGGER_NAME = "SliderThumbTrigger";
var SliderThumbTrigger = React62.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime38.jsx)(
      "span",
      {
        ...
        children: (0, import_jsx_runtime38.jsx)(Collection8.ItemSlot, { scope: __scopeSlider, children: (0, import_jsx_runtime38.jsx)(
          Primitive.span,
          {
            role: "slider",
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime38.jsx)(
      SliderThumbProvider,
      {
        __scopeSlider,
        name,
        internal_do_not_use_render: ({ index: index2, isFormControl: isFormControl2 }) => (0, import_jsx_runtime38.jsxs)(import_jsx_runtime38.Fragment, { children: [
          ...
          isFormControl2 ? (0, import_jsx_runtime38.jsx)(
            SliderBubbleInput,
            {
              __scopeSlider
            },
...
var SliderBubbleInput = React62.forwardRef(
...
function SwitchProvider(props) {
  ...
  const [control, setControl] = React63.useState(null);
  const [bubbleInput, setBubbleInput] = React63.useState(null);
  const hasConsumerStoppedPropagationRef = React63.useRef(false);
  const isFormControl2 = control ? !!form || !!control.closest("form") : (
    // We set this to true by default so that events bubble to forms without JS (SSR)
    true
  );
  ...
  return (0, import_jsx_runtime39.jsx)(SwitchProviderImpl, { scope: __scopeSwitch, ...context, children: isFunction6(internal_do_not_use_render) ? internal_do_not_use_render(context) : children });
}
var TRIGGER_NAME14 = "SwitchTrigger";
var SwitchTrigger = React63.forwardRef(
  ({ __scopeSwitch, onClick, ...switchProps }, forwardedRef) => {
    const {
      ...
      isFormControl: isFormControl2,
      bubbleInput
    } = useSwitchContext(TRIGGER_NAME14, __scopeSwitch);
    const composedRefs = useComposedRefs(forwardedRef, setControl);
...
SwitchTrigger.displayName = TRIGGER_NAME14;
var Switch = React63.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSwitch,
      name,
    ...
    return (0, import_jsx_runtime39.jsx)(
      SwitchProvider,
      {
        ...
        form,
        value,
        internal_do_not_use_render: ({ isFormControl: isFormControl2 }) => (0, import_jsx_runtime39.jsxs)(import_jsx_runtime39.Fragment, { children: [
...
var SwitchThumb = React63.forwardRef(
  (props, forwardedRef) => {
...
var SwitchBubbleInput = React63.forwardRef(
  ({ __scopeSwitch, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React63.useRef(checked);
    return (0, import_jsx_runtime39.jsx)(
      Primitive.input,
      {
        type: "checkbox",
...
var TRIGGER_NAME15 = "TabsTrigger";
var TabsTrigger = React64.forwardRef(
  (props, forwardedRef) => {
    const { __scopeTabs, value, disabled = false, ...triggerProps } = props;
    const context = useTabsContext(TRIGGER_NAME15, __scopeTabs);
    const rovingFocusGroupScope = useRovingFocusGroupScope5(__scopeTabs);
...
TabsTrigger.displayName = TRIGGER_NAME15;
...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = React65.useState(0);
  const isFocusedToastEscapeKeyDownRef = React65.useRef(false);
  const isClosePausedRef = React65.useRef(false);
  if (!label.trim()) {
    console.error(
      `Invalid prop \`label\` supplied to \`${PROVIDER_NAME2}\`. Expected non-empty \`string\`.`
    );
  }
  return (0, import_jsx_runtime41.jsx)(Collection9.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime41.jsx)(
    ToastProviderProvider,
    {
      ...
      viewport,
      onViewportChange: setViewport,
      onToastAdd: React65.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React65.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React65.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const wrapperRef = React65.useRef(null);
    const headFocusProxyRef = React65.useRef(null);
    const tailFocusProxyRef = React65.useRef(null);
    ...
    const getSortedTabbableCandidates = React65.useCallback(
      ({ tabbingDirection }) => {
    ...
    return (0, import_jsx_runtime41.jsxs)(
      Branch,
      {
        ...
        children: [
          hasToasts && (0, import_jsx_runtime41.jsx)(
            FocusProxy,
            {
          ...
          (0, import_jsx_runtime41.jsx)(Collection9.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime41.jsx)(Primitive.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime41.jsx)(
            FocusProxy,
            {
...
var FocusProxy = React65.forwardRef(
  (props, forwardedRef) => {
...
var Toast = React65.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime41.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime41.jsx)(
      ToastImpl,
      {
        open,
        ...toastProps,
...
var ToastImpl = React65.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const [node, setNode] = React65.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React65.useRef(null);
    const swipeDeltaRef = React65.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React65.useRef(0);
    const closeTimerRemainingTimeRef = React65.useRef(duration);
    ...
    const startTimer = React65.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React65.useMemo(() => {
      return node ? getAnnounceTextContent(node) : null;
    }, [node]);
    if (!context.viewport) return null;
    return (0, import_jsx_runtime41.jsxs)(import_jsx_runtime41.Fragment, { children: [
      announceTextContent && (0, import_jsx_runtime41.jsx)(
        ToastAnnounce,
        {
          __scopeToast,
          role: "status",
      ...
      (0, import_jsx_runtime41.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM6.createPortal(
        (0, import_jsx_runtime41.jsx)(Collection9.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime41.jsx)(
          Root4,
          {
            asChild: true,
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React65.useState(false);
  const [isAnnounced, setIsAnnounced] = React65.useState(false);
  useNextFrame(() => setRenderAnnounceText(true));
  React65.useEffect(() => {
    const timer = window.setTimeout(() => setIsAnnounced(true), 1e3);
    return () => window.clearTimeout(timer);
  }, []);
  return isAnnounced ? null : (0, import_jsx_runtime41.jsx)(Portal, { asChild: true, container: context.announcerContainer || void 0, children: (0, import_jsx_runtime41.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime41.jsxs)(import_jsx_runtime41.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React65.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...titleProps } = props;
    return (0, import_jsx_runtime41.jsx)(Primitive.div, { ...titleProps, ref: forwardedRef });
  }
);
ToastTitle.displayName = TITLE_NAME3;
var DESCRIPTION_NAME3 = "ToastDescription";
var ToastDescription = React65.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...descriptionProps } = props;
    return (0, import_jsx_runtime41.jsx)(Primitive.div, { ...descriptionProps, ref: forwardedRef });
  }
);
ToastDescription.displayName = DESCRIPTION_NAME3;
var ACTION_NAME2 = "ToastAction";
var ToastAction = React65.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime41.jsx)(ToastAnnounceExclude, { altText, asChild: true, children: (0, import_jsx_runtime41.jsx)(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
ToastAction.displayName = ACTION_NAME2;
var CLOSE_NAME3 = "ToastClose";
var ToastClose = React65.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...closeProps } = props;
    const interactiveContext = useToastInteractiveContext(CLOSE_NAME3, __scopeToast);
    return (0, import_jsx_runtime41.jsx)(ToastAnnounceExclude, { asChild: true, children: (0, import_jsx_runtime41.jsx)(
      Primitive.button,
      {
        type: "button",
        ...closeProps,
...
var ToastAnnounceExclude = React65.forwardRef((props, forwardedRef) => {
...
var NAME7 = "Toggle";
var Toggle = React66.forwardRef((props, forwardedRef) => {
...
var ToggleGroup = React67.forwardRef((props, forwardedRef) => {
  const { type, ...toggleGroupProps } = props;
  if (type === "single") {
    const singleProps = toggleGroupProps;
    return (0, import_jsx_runtime43.jsx)(ToggleGroupImplSingle, { role: "radiogroup", ...singleProps, ref: forwardedRef });
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return (0, import_jsx_runtime43.jsx)(ToggleGroupImplMultiple, { role: "toolbar", ...multipleProps, ref: forwardedRef });
  }
  throw new Error(`Missing prop \`type\` expected on \`${TOGGLE_GROUP_NAME}\``);
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
var [ToggleGroupValueProvider, useToggleGroupValueContext] = createToggleGroupContext(TOGGLE_GROUP_NAME);
var ToggleGroupImplSingle = React67.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  return (0, import_jsx_runtime43.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      type: "single",
      value: React67.useMemo(() => value ? [value] : [], [value]),
      onItemActivate: setValue,
      onItemDeactivate: React67.useCallback(() => setValue(""), [setValue]),
      children: (0, import_jsx_runtime43.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = React67.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  const handleButtonActivate = React67.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleButtonDeactivate = React67.useCallback(
    (itemValue) => setValue((prevValue = []) => prevValue.filter((value2) => value2 !== itemValue)),
    [setValue]
  );
  return (0, import_jsx_runtime43.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime43.jsx)(ToggleGroupImpl, { ...toggleGroupMultipleProps, ref: forwardedRef })
    }
  );
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
var [ToggleGroupContext, useToggleGroupContext] = createToggleGroupContext(TOGGLE_GROUP_NAME);
var ToggleGroupImpl = React67.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToggleGroup,
      disabled = false,
    ...
    return (0, import_jsx_runtime43.jsx)(ToggleGroupContext, { scope: __scopeToggleGroup, rovingFocus, disabled, children: rovingFocus ? (0, import_jsx_runtime43.jsx)(
      Root8,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime43.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime43.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef }) });
  }
);
var ITEM_NAME10 = "ToggleGroupItem";
var ToggleGroupItem = React67.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.rovingFocus ? (0, import_jsx_runtime43.jsx)(
      Item2,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        active: pressed,
        ref,
        children: (0, import_jsx_runtime43.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime43.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef });
  }
);
ToggleGroupItem.displayName = ITEM_NAME10;
var ToggleGroupItemImpl = React67.forwardRef(
  (props, forwardedRef) => {
...
var Toolbar = React68.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, orientation = "horizontal", dir, loop = true, ...toolbarProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    const direction = useDirection(dir);
    return (0, import_jsx_runtime44.jsx)(ToolbarProvider, { scope: __scopeToolbar, orientation, dir: direction, children: (0, import_jsx_runtime44.jsx)(
      Root8,
      {
        asChild: true,
        ...rovingFocusGroupScope,
...
var ToolbarSeparator = React68.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React68.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...buttonProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime44.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !props.disabled, children: (0, import_jsx_runtime44.jsx)(Primitive.button, { type: "button", ...buttonProps, ref: forwardedRef }) });
  }
);
ToolbarButton.displayName = BUTTON_NAME;
var LINK_NAME2 = "ToolbarLink";
var ToolbarLink = React68.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...linkProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime44.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: true, children: (0, import_jsx_runtime44.jsx)(
      Primitive.a,
      {
        ...linkProps,
        ref: forwardedRef,
...
var ToolbarToggleGroup = React68.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React68.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...toggleItemProps } = props;
    const toggleGroupScope = useToggleGroupScope(__scopeToolbar);
    const scope = { __scopeToolbar: props.__scopeToolbar };
    return (0, import_jsx_runtime44.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime44.jsx)(ToggleGroupItem, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React69.useRef(true);
  const isPointerInTransitRef = React69.useRef(false);
  ...
  return (0, import_jsx_runtime45.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React69.useCallback(() => {
        if (skipDelayDuration <= 0) return;
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, [skipDelayDuration]),
      onClose: React69.useCallback(() => {
        if (skipDelayDuration <= 0) return;
        window.clearTimeout(skipDelayTimerRef.current);
        skipDelayTimerRef.current = window.setTimeout(
      ...
      onPointerInTransitChange: React69.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const [trigger, setTrigger] = React69.useState(null);
  const contentId = useId();
  const openTimerRef = React69.useRef(0);
  const disableHoverableContent = disableHoverableContentProp ?? providerContext.disableHoverableContent;
  const delayDuration = delayDurationProp ?? providerContext.delayDuration;
  const wasOpenDelayedRef = React69.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React69.useMemo(() => {
  ...
  return (0, import_jsx_runtime45.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime45.jsx)(
    TooltipContextProvider,
    {
      ...
      trigger,
      onTriggerChange: setTrigger,
      onTriggerEnter: React69.useCallback(() => {
        if (providerContext.isOpenDelayedRef.current) handleDelayedOpen();
        else handleOpen();
      }, [providerContext.isOpenDelayedRef, handleDelayedOpen, handleOpen]),
      onTriggerLeave: React69.useCallback(() => {
...
var TRIGGER_NAME16 = "TooltipTrigger";
var TooltipTrigger = React69.forwardRef(
  (props, forwardedRef) => {
    const { __scopeTooltip, ...triggerProps } = props;
    const context = useTooltipContext(TRIGGER_NAME16, __scopeTooltip);
    const providerContext = useTooltipProviderContext(TRIGGER_NAME16, __scopeTooltip);
    const popperScope = usePopperScope5(__scopeTooltip);
    ...
    const handlePointerUp = React69.useCallback(() => isPointerDownRef.current = false, []);
    React69.useEffect(() => {
      return () => document.removeEventListener("pointerup", handlePointerUp);
    }, [handlePointerUp]);
    return (0, import_jsx_runtime45.jsx)(Anchor, { asChild: true, ...popperScope, children: (0, import_jsx_runtime45.jsx)(
      Primitive.button,
      {
...
TooltipTrigger.displayName = TRIGGER_NAME16;
var PORTAL_NAME11 = "TooltipPortal";
var [PortalProvider6, usePortalContext6] = createTooltipContext(PORTAL_NAME11, {
  forceMount: void 0
});
var TooltipPortal = (props) => {
  const { __scopeTooltip, forceMount, children, container } = props;
  const context = useTooltipContext(PORTAL_NAME11, __scopeTooltip);
  return (0, import_jsx_runtime45.jsx)(PortalProvider6, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime45.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime45.jsx)(Portal, { asChild: true, container, children }) }) });
};
TooltipPortal.displayName = PORTAL_NAME11;
var CONTENT_NAME15 = "TooltipContent";
var TooltipContent = React69.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext6(CONTENT_NAME15, props.__scopeTooltip);
    const { forceMount = portalContext.forceMount, side = "top", ...contentProps } = props;
    const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
    return (0, import_jsx_runtime45.jsx)(Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? (0, import_jsx_runtime45.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime45.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React69.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME15, props.__scopeTooltip);
  const ref = React69.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React69.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React69.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React69.useCallback(
    (event, hoverTarget) => {
  ...
  return (0, import_jsx_runtime45.jsx)(TooltipContentImpl, { ...props, ref: composedRefs });
});
var [VisuallyHiddenContentContextProvider, useVisuallyHiddenContentContext] = createTooltipContext(TOOLTIP_NAME, { isInside: false });
var Slottable2 = createSlottable("TooltipContent");
var TooltipContentImpl = React69.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
    ...
    return (0, import_jsx_runtime45.jsx)(
      DismissableLayer,
      {
        ...
        onFocusOutside: (event) => event.preventDefault(),
        onDismiss: onClose,
        children: (0, import_jsx_runtime45.jsxs)(
          Content3,
          {
            "data-state": context.stateAttribute,
            ...popperScope,
            ...
            children: [
              (0, import_jsx_runtime45.jsx)(Slottable2, { children }),
              (0, import_jsx_runtime45.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime45.jsx)(Root2, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React69.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime45.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
