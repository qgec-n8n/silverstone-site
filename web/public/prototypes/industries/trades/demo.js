/*
  Job-intake dispatch board — synthetic demo scenario for the Trades & home services industry page.
...
const DATA = {
  ...
  "options": [
    ...
    {
      "value": "booking",
      "label": "Standard job booking",
      "route": "auto"
    },
    {
      "value": "emergency",
      "label": "Emergency / safety issue",
      "route": "human"
    }
  ],
  "autoStages": [
  ...
  "humanStage": "Flagged for the office",
  "autoSummary": "Synthetic run: location, job type and photos are captured, the enquiry is triaged and a callback is offered, then a summary is prepared for the office. Price and attendance stay unconfirmed.",
  "humanSummary": "Synthetic run: an emergency or safety issue is flagged straight to the office. Automation gathers detail but never commits an arrival time, price or safety outcome."
};
