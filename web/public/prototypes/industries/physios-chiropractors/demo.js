/*
  Non-clinical intake boundary — synthetic demo scenario for the Physio & chiropractic clinics industry page.
...
const DATA = {
  ...
  "options": [
    ...
    {
      "value": "clinical",
      "label": "Clinical / urgent question",
      "route": "human"
    }
  ],
  "autoStages": [
  ...
  "humanStage": "Routed to the clinic team",
  "autoSummary": "Synthetic run: contact, clinic preference and a high-level reason are captured, a slot is offered and a preparation summary is readied. No clinical content is handled.",
  "humanSummary": "Synthetic run: a clinical or urgent question crosses the boundary immediately to the clinic team or urgent-care guidance. Automation never triages, advises or diagnoses."
};
