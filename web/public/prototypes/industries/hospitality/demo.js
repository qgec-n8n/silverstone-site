/*
  Guest-journey service bell — synthetic demo scenario for the Hospitality industry page.
...
const DATA = {
  ...
  "options": [
    ...
    {
      "value": "change",
      "label": "Booking change request",
      "route": "auto"
    },
    {
      "value": "allergy",
      "label": "Allergy / accessibility need",
      "route": "human"
    }
  ],
  "autoStages": [
  ...
  "humanStage": "Rung through to the duty manager",
  "autoSummary": "Synthetic run: the message is matched to a reservation, an option is offered and a summary is prepared for staff to confirm. Nothing is committed automatically.",
  "humanSummary": "Synthetic run: an allergy or accessibility need is treated as safety-critical and rung straight through to the duty manager. Automation never answers it on the venue's behalf."
};
