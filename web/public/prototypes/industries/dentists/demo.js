/*
  Patient-admin recall orbit — synthetic demo scenario for the Dental practices industry page.
...
const DATA = {
  ...
  "options": [
    ...
    {
      "value": "clinical",
      "label": "Clinical / treatment question",
      "route": "human"
    }
  ],
  "autoStages": [
  ...
  "humanStage": "Routed to the practice team",
  "autoSummary": "Synthetic run: the request is matched to a record and a recall or slot is offered, then a summary is prepared for the practice. No clinical decision is made.",
  "humanSummary": "Synthetic run: a treatment or clinical question is routed to the practice team. The orbit handles admin only — it never enters the clinical-decision core."
};
