...
- [x] (2025-12-06T01:44Z) Confirm repo structure and existing design patterns (header, hero, parallax, neon cards, stats, FAQs, footer).
- [x] (2025-12-06T01:44Z) Confirm canonical ExecPlan location `.agent/plans/real-estate-landing-page.md` and ensure `.agent/PLANS.md` and `.agent/AGENTS.md` are up to date.
- [x] (2025-12-06T01:44Z) Decide exact file path for the new niche page (`niches/estate-agents.html`) and create the `niches/` directory if it does not exist.
- [x] (2025-12-06T01:44Z) Implement the Estate Agents hero section with gold/amber hero shader variant, accurate copy, bullet list, and CTAs.
- [x] (2025-12-06T01:44Z) Implement the Niche Pain section (3.2) using service-row style with Real_Estate_1 image and neon card, including iconised bullet list.
- [x] (2025-12-06T01:44Z) Implement the Bundle / Counter-Product Overview section (3.3) using service-row style with Real_Estate_2 image and neon card, section heading, and iconised bullets.
- [x] (2025-12-06T01:44Z) Implement the Proof in Numbers strip (3.4) as four static stats cards with top icons and percentages, and adjust `assets/js/script.js` so this section does **not** animate.
- [x] (2025-12-06T01:44Z) Implement the Outcomes & Benefits section (3.5) using service-row style with Real_Estate_3 image and neon card, with iconised outcome bullets and alternating orientation.
- [x] (2025-12-06T01:44Z) Implement How It Works (3.6) as a row of four value-style neon cards with top icons and explanatory copy.
- [x] (2025-12-06T01:44Z) Implement Risk Reversal & Reassurance (3.7) as a row of four value-style neon cards plus intro paragraph.
- [x] (2025-12-06T01:44Z) Insert a visually integrated but minimal Pricing Placeholder section (3.8) ready for future pricing content.
- [x] (2025-12-06T01:44Z) Implement the FAQs section (3.9) using the existing FAQ `<details>` pattern, populated with Q&A from Section 8 of the spec.
- [x] (2025-12-06T01:44Z) Implement the final CTA block (3.10) using the shared CTA pattern from index/about/book.
- [x] (2025-12-06T01:44Z) Ensure the footer (3.11) is identical to the main pages and that the logo loads correctly.
- [x] (2025-12-06T01:44Z) Wire the navigation so the “Estate Agents” link under the Services dropdown points to `/niches/estate-agents` rather than a `services.html#estate-agents` anchor.
