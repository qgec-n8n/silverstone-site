/**
 * SINGLE MARQUEE: HOME, ABOUT, CONTACT, BOOK
 *
 * Logic:
 * 1. Global Footer Variant.
 * 2. Injects Single Row Marquee (Left Scroll).
...
(function () {
    ...
    function initSingleMarquee() {
        if (document.querySelector('.premium-marquee-container.global-footer')) return;
