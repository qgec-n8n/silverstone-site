/**
 * SINGLE MARQUEE (Global footer ribbon)
 * - Injects a single scrolling row above the footer on non-Services pages.
 * - Shares the marquee lightbox with the services gallery.
 */
(function () {
  'use strict';
  ...
  function init() {
    ...
    ensureLightbox();
    const marquee = createContainer();
    marquee.classList.add('single-marquee-container');
  ...
  function createContainer() {
    ...
    track.className = 'marquee-track scroll-left';

    const firstPass = createImages(MARQUEE_IMAGES);
    const secondPass = createImages(MARQUEE_IMAGES);
