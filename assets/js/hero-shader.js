...
(function () {
  ...
  const THEMES = {
    ...
    // Niche variants keep within the existing palette while giving each industry a subtle accent
    realestate: {
      line: [0.0, 0.82, 0.78, 1.0],
      bg1: [0.02, 0.15, 0.18, 1.0],
      bg2: [0.0, 0.28, 0.35, 1.0]
    },
    hospitality: {
      line: [0.0, 0.7, 1.0, 1.0],
      bg1: [0.05, 0.08, 0.2, 1.0],
      bg2: [0.1, 0.18, 0.32, 1.0]
    },
    salons: {
      line: [0.0, 1.0, 0.62, 1.0],
      bg1: [0.08, 0.16, 0.15, 1.0],
      bg2: [0.12, 0.28, 0.24, 1.0]
    },
    trades: {
      line: [0.24, 0.78, 1.0, 1.0],
      bg1: [0.05, 0.12, 0.18, 1.0],
      bg2: [0.1, 0.22, 0.32, 1.0]
    },
    ecommerce: {
      line: [0.5, 0.82, 1.0, 1.0],
      bg1: [0.08, 0.08, 0.2, 1.0],
      bg2: [0.12, 0.22, 0.36, 1.0]
    },
    dentists: {
      line: [0.36, 0.9, 0.96, 1.0],
      bg1: [0.06, 0.16, 0.2, 1.0],
      bg2: [0.1, 0.28, 0.32, 1.0]
    },
    physio: {
      line: [0.0, 0.85, 0.7, 1.0],
      bg1: [0.04, 0.16, 0.16, 1.0],
      bg2: [0.09, 0.28, 0.28, 1.0]
    },
    gyms: {
      line: [0.0, 0.9, 0.5, 1.0],
      bg1: [0.05, 0.12, 0.18, 1.0],
      bg2: [0.1, 0.24, 0.28, 1.0]
    },
    coaches: {
      line: [0.65, 0.7, 1.0, 1.0],
      bg1: [0.08, 0.1, 0.2, 1.0],
      bg2: [0.12, 0.22, 0.34, 1.0]
    }
  };
