...
(function () {
  ...
  const THEMES = {
    ...
    // Niche pages (unique colourways)
    violet: {
      line: [0.78, 0.56, 1.0, 1.0],
      bg1: [0.12, 0.05, 0.2, 1.0],
      bg2: [0.25, 0.12, 0.35, 1.0]
    },
    teal: {
      line: [0.18, 0.92, 0.86, 1.0],
      bg1: [0.03, 0.12, 0.14, 1.0],
      bg2: [0.05, 0.24, 0.28, 1.0]
    },
    rose: {
      line: [1.0, 0.55, 0.75, 1.0],
      bg1: [0.18, 0.06, 0.12, 1.0],
      bg2: [0.32, 0.12, 0.22, 1.0]
    },
    ember: {
      line: [1.0, 0.48, 0.24, 1.0],
      bg1: [0.18, 0.06, 0.02, 1.0],
      bg2: [0.32, 0.12, 0.05, 1.0]
    },
    neonpink: {
      line: [0.98, 0.35, 0.75, 1.0],
      bg1: [0.14, 0.04, 0.14, 1.0],
      bg2: [0.3, 0.08, 0.28, 1.0]
    }
  };
