...
(function () {
  ...
  const THEMES = {
    ...
    // Real Estate (Violet)
    violet: {
      line: [0.74, 0.4, 1.0, 1.0],
      bg1: [0.12, 0.05, 0.24, 1.0],
      bg2: [0.24, 0.12, 0.42, 1.0]
    },
    // Hospitality (Copper/Amber blend)
    copper: {
      line: [0.98, 0.58, 0.26, 1.0],
      bg1: [0.18, 0.07, 0.02, 1.0],
      bg2: [0.32, 0.14, 0.06, 1.0]
    },
    // Salons (Rose)
    rose: {
      line: [1.0, 0.46, 0.68, 1.0],
      bg1: [0.22, 0.06, 0.14, 1.0],
      bg2: [0.38, 0.12, 0.24, 1.0]
    },
    // Trades (Steel)
    steel: {
      line: [0.64, 0.78, 0.92, 1.0],
      bg1: [0.08, 0.11, 0.16, 1.0],
      bg2: [0.16, 0.2, 0.28, 1.0]
    },
    // eCommerce (Cobalt)
    cobalt: {
      line: [0.16, 0.63, 1.0, 1.0],
      bg1: [0.06, 0.08, 0.18, 1.0],
      bg2: [0.1, 0.2, 0.36, 1.0]
    },
    // Physios & Chiropractors (Mint)
    mint: {
      line: [0.28, 0.98, 0.8, 1.0],
      bg1: [0.04, 0.14, 0.12, 1.0],
      bg2: [0.1, 0.24, 0.22, 1.0]
    },
    // Dentists (Aqua)
    aqua: {
      line: [0.34, 0.9, 1.0, 1.0],
      bg1: [0.06, 0.12, 0.16, 1.0],
      bg2: [0.12, 0.22, 0.28, 1.0]
    },
    // Gym Owners (Lime)
    lime: {
      line: [0.76, 1.0, 0.32, 1.0],
      bg1: [0.08, 0.14, 0.04, 1.0],
      bg2: [0.16, 0.28, 0.1, 1.0]
    },
    // Fitness Influencers / Coaches (Orchid)
    orchid: {
      line: [0.86, 0.52, 1.0, 1.0],
      bg1: [0.16, 0.06, 0.2, 1.0],
      bg2: [0.28, 0.12, 0.32, 1.0]
    }
  };
