...
(function () {
  ...
  const THEMES = {
    ...
    // Niche variants
    violet: {
      line: [0.85, 0.5, 1.0, 1.0],
      bg1: [0.15, 0.07, 0.2, 1.0],
      bg2: [0.25, 0.1, 0.35, 1.0]
    },
    teal: {
      line: [0.2, 0.9, 0.8, 1.0],
      bg1: [0.05, 0.14, 0.14, 1.0],
      bg2: [0.07, 0.24, 0.26, 1.0]
    },
    rose: {
      line: [1.0, 0.45, 0.7, 1.0],
      bg1: [0.16, 0.05, 0.12, 1.0],
      bg2: [0.28, 0.1, 0.2, 1.0]
    },
    copper: {
      line: [1.0, 0.55, 0.25, 1.0],
      bg1: [0.16, 0.07, 0.02, 1.0],
      bg2: [0.32, 0.18, 0.08, 1.0]
    },
    aqua: {
      line: [0.3, 0.9, 1.0, 1.0],
      bg1: [0.05, 0.1, 0.18, 1.0],
      bg2: [0.08, 0.22, 0.32, 1.0]
    },
    mint: {
      line: [0.4, 1.0, 0.8, 1.0],
      bg1: [0.05, 0.15, 0.12, 1.0],
      bg2: [0.12, 0.28, 0.22, 1.0]
    },
    ice: {
      line: [0.7, 0.9, 1.0, 1.0],
      bg1: [0.08, 0.12, 0.2, 1.0],
      bg2: [0.15, 0.24, 0.32, 1.0]
    },
    electric: {
      line: [0.6, 0.3, 1.0, 1.0],
      bg1: [0.1, 0.08, 0.22, 1.0],
      bg2: [0.18, 0.12, 0.32, 1.0]
    },
    sunset: {
      line: [1.0, 0.55, 0.9, 1.0],
      bg1: [0.14, 0.04, 0.12, 1.0],
      bg2: [0.26, 0.1, 0.22, 1.0]
    }
  };
