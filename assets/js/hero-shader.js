...
(function () {
  ...
  const THEMES = {
    ...
    // Niche variants for dedicated landing pages
    violet: {
      line: [0.72, 0.5, 1.0, 1.0],
      bg1: [0.12, 0.05, 0.2, 1.0],
      bg2: [0.25, 0.1, 0.38, 1.0]
    },
    coral: {
      line: [1.0, 0.55, 0.45, 1.0],
      bg1: [0.18, 0.06, 0.05, 1.0],
      bg2: [0.32, 0.12, 0.1, 1.0]
    },
    pink: {
      line: [1.0, 0.45, 0.82, 1.0],
      bg1: [0.18, 0.05, 0.14, 1.0],
      bg2: [0.3, 0.1, 0.22, 1.0]
    },
    orange: {
      line: [1.0, 0.62, 0.25, 1.0],
      bg1: [0.16, 0.07, 0.02, 1.0],
      bg2: [0.3, 0.15, 0.06, 1.0]
    },
    cyan: {
      line: [0.35, 0.95, 1.0, 1.0],
      bg1: [0.05, 0.12, 0.15, 1.0],
      bg2: [0.1, 0.24, 0.3, 1.0]
    },
    mint: {
      line: [0.65, 1.0, 0.82, 1.0],
      bg1: [0.05, 0.16, 0.12, 1.0],
      bg2: [0.1, 0.28, 0.2, 1.0]
    },
    steel: {
      line: [0.7, 0.82, 1.0, 1.0],
      bg1: [0.08, 0.12, 0.18, 1.0],
      bg2: [0.16, 0.22, 0.3, 1.0]
    },
    indigo: {
      line: [0.42, 0.6, 1.0, 1.0],
      bg1: [0.08, 0.08, 0.2, 1.0],
      bg2: [0.16, 0.18, 0.32, 1.0]
    },
    rose: {
      line: [1.0, 0.62, 0.72, 1.0],
      bg1: [0.18, 0.06, 0.1, 1.0],
      bg2: [0.32, 0.12, 0.18, 1.0]
    }
  };
