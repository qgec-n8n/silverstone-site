...
(function () {
  ...
  const THEMES = {
    ...
    estate: {
      ...
      bg1: [0.02, 0.08, 0.18, 1.0],
      bg2: [0.02, 0.22, 0.36, 1.0]
    },
    hospitality: {
      line: [0.95, 0.65, 0.2, 1.0],
      bg1: [0.15, 0.08, 0.04, 1.0],
      bg2: [0.26, 0.14, 0.08, 1.0]
    },
    salons: {
      line: [0.35, 0.9, 0.75, 1.0],
      bg1: [0.04, 0.12, 0.18, 1.0],
      bg2: [0.08, 0.24, 0.28, 1.0]
    },
    trades: {
      line: [0.0, 0.72, 0.94, 1.0],
      bg1: [0.06, 0.08, 0.16, 1.0],
      bg2: [0.1, 0.2, 0.32, 1.0]
    },
    ecommerce: {
      line: [0.55, 0.75, 1.0, 1.0],
      bg1: [0.05, 0.08, 0.2, 1.0],
      bg2: [0.14, 0.2, 0.32, 1.0]
    },
    physio: {
      line: [0.0, 0.82, 0.56, 1.0],
      bg1: [0.02, 0.14, 0.1, 1.0],
      bg2: [0.05, 0.26, 0.2, 1.0]
    },
    dentist: {
      line: [0.3, 0.92, 1.0, 1.0],
      bg1: [0.03, 0.12, 0.18, 1.0],
      bg2: [0.08, 0.26, 0.32, 1.0]
    },
    gym: {
      line: [0.0, 0.78, 0.42, 1.0],
      bg1: [0.02, 0.12, 0.12, 1.0],
      bg2: [0.08, 0.22, 0.26, 1.0]
    },
    coaching: {
      line: [0.6, 0.55, 1.0, 1.0],
      bg1: [0.08, 0.08, 0.18, 1.0],
      bg2: [0.16, 0.12, 0.32, 1.0]
    }
  };
