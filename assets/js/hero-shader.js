...
(function () {
  ...
  const THEMES = {
    ...
    // Niche variants
    'real-estate': {
      line: [0.0, 0.78, 0.94, 1.0],
      bg1: [0.02, 0.08, 0.2, 1.0],
      bg2: [0.05, 0.25, 0.45, 1.0]
    },
    hospitality: {
      line: [0.95, 0.55, 0.15, 1.0],
      bg1: [0.16, 0.08, 0.02, 1.0],
      bg2: [0.28, 0.16, 0.05, 1.0]
    },
    salons: {
      line: [0.8, 0.3, 0.8, 1.0],
      bg1: [0.12, 0.05, 0.18, 1.0],
      bg2: [0.22, 0.12, 0.32, 1.0]
    },
    trades: {
      line: [0.15, 0.7, 0.85, 1.0],
      bg1: [0.04, 0.06, 0.12, 1.0],
      bg2: [0.08, 0.18, 0.28, 1.0]
    },
    ecommerce: {
      line: [0.35, 0.7, 1.0, 1.0],
      bg1: [0.05, 0.08, 0.18, 1.0],
      bg2: [0.12, 0.18, 0.38, 1.0]
    },
    'physios-chiropractors': {
      line: [0.0, 0.85, 0.6, 1.0],
      bg1: [0.02, 0.12, 0.08, 1.0],
      bg2: [0.08, 0.25, 0.2, 1.0]
    },
    dentists: {
      line: [0.55, 0.8, 0.95, 1.0],
      bg1: [0.06, 0.08, 0.12, 1.0],
      bg2: [0.12, 0.2, 0.3, 1.0]
    },
    'gym-owners': {
      line: [0.0, 0.78, 0.9, 1.0],
      bg1: [0.05, 0.08, 0.14, 1.0],
      bg2: [0.15, 0.18, 0.3, 1.0]
    },
    'fitness-influencers-online-coaches': {
      line: [0.85, 0.4, 0.95, 1.0],
      bg1: [0.1, 0.05, 0.15, 1.0],
      bg2: [0.22, 0.1, 0.28, 1.0]
    }
  };
