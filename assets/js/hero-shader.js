...
(function () {
  ...
  const THEMES = {
    ...
    violet: {
      line: [0.78, 0.55, 1.0, 1.0],
      bg1: [0.15, 0.05, 0.2, 1.0],
      bg2: [0.25, 0.1, 0.35, 1.0]
    },
    teal: {
      line: [0.0, 0.85, 0.78, 1.0],
      bg1: [0.02, 0.12, 0.15, 1.0],
      bg2: [0.05, 0.25, 0.3, 1.0]
    },
    coral: {
      line: [1.0, 0.48, 0.45, 1.0],
      bg1: [0.18, 0.05, 0.05, 1.0],
      bg2: [0.32, 0.08, 0.08, 1.0]
    },
    magenta: {
      line: [1.0, 0.3, 0.7, 1.0],
      bg1: [0.18, 0.05, 0.18, 1.0],
      bg2: [0.32, 0.1, 0.32, 1.0]
    },
    indigo: {
      line: [0.4, 0.55, 1.0, 1.0],
      bg1: [0.08, 0.08, 0.2, 1.0],
      bg2: [0.14, 0.14, 0.32, 1.0]
    },
    emerald: {
      line: [0.0, 0.95, 0.55, 1.0],
      bg1: [0.02, 0.15, 0.1, 1.0],
      bg2: [0.05, 0.3, 0.22, 1.0]
    },
    rose: {
      line: [1.0, 0.58, 0.8, 1.0],
      bg1: [0.18, 0.05, 0.12, 1.0],
      bg2: [0.32, 0.1, 0.22, 1.0]
    },
    cyan: {
      line: [0.0, 0.9, 1.0, 1.0],
      bg1: [0.05, 0.12, 0.2, 1.0],
      bg2: [0.08, 0.24, 0.32, 1.0]
    },
    amberdeep: {
      line: [1.0, 0.72, 0.25, 1.0],
      bg1: [0.16, 0.09, 0.02, 1.0],
      bg2: [0.28, 0.15, 0.05, 1.0]
    }
  };
