...
(function () {
  ...
  const THEMES = {
    ...
    teal: {
      line: [0.0, 0.82, 0.82, 1.0],
      bg1: [0.02, 0.12, 0.12, 1.0],
      bg2: [0.05, 0.24, 0.24, 1.0]
    },
    magenta: {
      line: [0.9, 0.25, 0.75, 1.0],
      bg1: [0.18, 0.03, 0.14, 1.0],
      bg2: [0.32, 0.08, 0.26, 1.0]
    },
    violet: {
      line: [0.65, 0.45, 1.0, 1.0],
      bg1: [0.1, 0.07, 0.2, 1.0],
      bg2: [0.2, 0.12, 0.35, 1.0]
    },
    cyan: {
      line: [0.2, 0.9, 1.0, 1.0],
      bg1: [0.05, 0.12, 0.18, 1.0],
      bg2: [0.08, 0.2, 0.28, 1.0]
    },
    emerald: {
      line: [0.0, 0.95, 0.55, 1.0],
      bg1: [0.03, 0.15, 0.1, 1.0],
      bg2: [0.06, 0.25, 0.18, 1.0]
    },
    coral: {
      line: [1.0, 0.45, 0.4, 1.0],
      bg1: [0.16, 0.05, 0.04, 1.0],
      bg2: [0.28, 0.12, 0.1, 1.0]
    },
    indigo: {
      line: [0.35, 0.35, 0.9, 1.0],
      bg1: [0.05, 0.06, 0.18, 1.0],
      bg2: [0.1, 0.12, 0.3, 1.0]
    },
    aqua: {
      line: [0.15, 0.95, 0.8, 1.0],
      bg1: [0.03, 0.12, 0.12, 1.0],
      bg2: [0.08, 0.22, 0.22, 1.0]
    },
    rose: {
      line: [1.0, 0.5, 0.7, 1.0],
      bg1: [0.18, 0.07, 0.1, 1.0],
      bg2: [0.28, 0.12, 0.18, 1.0]
    }
  };
