...
(function () {
  ...
  const THEMES = {
    ...
    // Niche variants
    violet: {
      line: [0.7, 0.35, 1.0, 1.0],
      bg1: [0.15, 0.05, 0.25, 1.0],
      bg2: [0.25, 0.1, 0.35, 1.0]
    },
    amberwave: {
      line: [1.0, 0.7, 0.3, 1.0],
      bg1: [0.2, 0.08, 0.0, 1.0],
      bg2: [0.35, 0.15, 0.05, 1.0]
    },
    rose: {
      line: [1.0, 0.4, 0.7, 1.0],
      bg1: [0.22, 0.05, 0.15, 1.0],
      bg2: [0.35, 0.12, 0.22, 1.0]
    },
    ember: {
      line: [1.0, 0.5, 0.2, 1.0],
      bg1: [0.2, 0.08, 0.02, 1.0],
      bg2: [0.35, 0.18, 0.05, 1.0]
    },
    aqua: {
      line: [0.2, 0.95, 0.95, 1.0],
      bg1: [0.05, 0.18, 0.2, 1.0],
      bg2: [0.08, 0.25, 0.32, 1.0]
    },
    teal: {
      line: [0.2, 0.85, 0.75, 1.0],
      bg1: [0.04, 0.18, 0.16, 1.0],
      bg2: [0.08, 0.28, 0.25, 1.0]
    },
    mint: {
      line: [0.6, 1.0, 0.85, 1.0],
      bg1: [0.1, 0.22, 0.18, 1.0],
      bg2: [0.12, 0.35, 0.28, 1.0]
    },
    lime: {
      line: [0.7, 1.0, 0.35, 1.0],
      bg1: [0.12, 0.22, 0.08, 1.0],
      bg2: [0.16, 0.35, 0.12, 1.0]
    },
    magenta: {
      line: [0.95, 0.25, 0.75, 1.0],
      bg1: [0.16, 0.05, 0.2, 1.0],
      bg2: [0.26, 0.08, 0.3, 1.0]
    }
  };
