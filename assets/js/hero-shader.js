...
(function () {
  ...
  const THEMES = {
    ...
    'real-estate': {
      line: [0.0, 0.68, 0.94, 1.0],
      bg1: [0.0, 0.07, 0.2, 1.0],
      bg2: [0.0, 0.22, 0.42, 1.0]
    },
    hospitality: {
      line: [1.0, 0.65, 0.0, 1.0],
      bg1: [0.12, 0.06, 0.0, 1.0],
      bg2: [0.28, 0.12, 0.02, 1.0]
    },
    salons: {
      line: [0.6, 0.3, 0.9, 1.0],
      bg1: [0.1, 0.05, 0.18, 1.0],
      bg2: [0.22, 0.08, 0.32, 1.0]
    },
    trades: {
      line: [0.9, 0.75, 0.4, 1.0],
      bg1: [0.08, 0.08, 0.1, 1.0],
      bg2: [0.16, 0.12, 0.18, 1.0]
    },
    ecommerce: {
      line: [0.0, 1.0, 0.62, 1.0],
      bg1: [0.0, 0.18, 0.16, 1.0],
      bg2: [0.0, 0.32, 0.28, 1.0]
    },
    'physios-chiropractors': {
      line: [0.0, 1.0, 0.62, 1.0],
      bg1: [0.02, 0.18, 0.14, 1.0],
      bg2: [0.05, 0.36, 0.3, 1.0]
    },
    dentists: {
      line: [0.65, 0.9, 1.0, 1.0],
      bg1: [0.06, 0.12, 0.16, 1.0],
      bg2: [0.18, 0.26, 0.32, 1.0]
    },
    'gym-owners': {
      line: [0.8, 0.4, 1.0, 1.0],
      bg1: [0.12, 0.06, 0.16, 1.0],
      bg2: [0.26, 0.12, 0.32, 1.0]
    },
