...
**Current phase:** `/web` Motion foundation migrated and verified; legacy root remains frozen.
...
- Current `/web` app passes the bundle hard ceiling but still misses the 220 KB target: `298.67 KB gzip`.
